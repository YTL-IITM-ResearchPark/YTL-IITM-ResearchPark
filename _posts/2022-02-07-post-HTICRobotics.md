...
Type: 
```
export PATH="/home/YTL-IITM-ResearchPark/anaconda3/bin:$PATH"
```
...
I have used this while collection data during [here](https://github.com/YTL-IITM-ResearchPark/htic_spine_surgery_robotics/blob/main/src/python_codes/force_torque_DataCollection.py).
